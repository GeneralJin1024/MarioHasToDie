...
namespace FinalSprint.LevelLoader
{
    public class LevelManager : IDisposable
    {
        ...
        public void Initialize()
        {
            ...
            {
                Stage stage = new Stage(Sprint5Main.Game);
            ...
            GameMenu = new Menu(Sprint5Main.Game, new string[] { "Welcome To Mario", "Start", "Quit" });
            GameOver = new Menu(Sprint5Main.Game, new string[] { "Game Over", "Replay", "Exit" });
            GameWin = new Menu(Sprint5Main.Game, new string[] { "Congratulations", "Replay", "Exit", "Next Level"});
            //currScene.Dispose();
        }
        ...
        public void LoadContent()
        {
            ...
            CurrSceneIndex = 1;
            #region Fonts
            instructionFont = Sprint5Main.Game.Content.Load<SpriteFont>("arial");
            #endregion
            //create HUD pictures.
            Coin = new AnimatedSprite(
                Sprint5Main.Game.Content.Load<Texture2D>("ItemSprite/coin"), new Point(1, 4), new MoveParameters(false));
            Coin.Parameters.SetPosition(156, 41);
            Mario = new AnimatedSprite(Sprint5Main.Game.Content.Load<Texture2D>("MarioSprites/smallMarioRightStand"), 
        ...
        public void Draw(SpriteBatch spriteBatch)
        {
            ...
            if (Mode != 1) // only in normal level (not secrete area), the background is Blue.
                Sprint5Main.Game.GraphicsDevice.Clear(Color.Black);

            spriteBatch.Begin(blendState: BlendState.AlphaBlend);
            Color fontColor = Mode == 1 && Stage.BackgroundColor != Color.Black ? Color.Black : Color.White;
            spriteBatch.DrawString(instructionFont, ":   " + Sprint5Main.Coins, new Vector2(172, 20), fontColor,
            ...
            spriteBatch.DrawString(instructionFont, StringManager.GetString("MARIO", CultureInfo.CurrentCulture), new Vector2(20, 0), fontColor,
                0, Vector2.Zero, 1.2f, SpriteEffects.None, 0);
            spriteBatch.DrawString(instructionFont, "" + Sprint5Main.Point, new Vector2(20, 20), fontColor,
                0, Vector2.Zero, 1.2f, SpriteEffects.None, 0);
            ...
            spriteBatch.DrawString(instructionFont, StringManager.GetString("WORLD", CultureInfo.CurrentCulture), new Vector2(480, 0), fontColor, 
                0, Vector2.Zero, 1.2f, SpriteEffects.None, 0);
            spriteBatch.DrawString(instructionFont, " : " + Sprint5Main.MarioLife,
        ...
        public void MarioDied()
        {
            ...
            if (Sprint5Main.MarioLife > 0) //reborn at check point.
            {
                SceneFlash(true, true, CurrSceneIndex); SoundFactory.Instance.BackgroundMusic.Play();
            }
            else //game over.
            {
                ChangeToGamoverMode(); Sprint5Main.MarioLife = 3;
            }
        }
        ...
        public void ChangeToGamoverMode()
        {
            ...
            Mode = 2; Sprint5Main.Point = 0; Sprint5Main.Coins = 0;
        ...
        public void ChangeToWinMode() { Mode = 3; Sprint5Main.MarioLife = 3; SceneFlash(true, false, CurrSceneIndex); GotoNextScene(); }
        public void ChangeToLoadingMode() { Mode = 4; }

        // Add Points based on the rest of time when Mario wins the current level.
        public void AddTimeBonus() { Sprint5Main.Point += ((int)RestOfTime + 1) * 10; }
