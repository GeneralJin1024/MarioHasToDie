...
namespace Sprint1.ItemClasses
{
    class BombCharacter : ItemCharacter
    {
        ...
        public override Sprint1Main.CharacterType Type { get; set; } = Sprint1Main.CharacterType.Bomb;
        ...
        {
            if(!Bombed && Parameters.IsHidden && (Parameters.Position.X - Sprint1Main.Game.Scene.Mario.GetMaxPosition.X <= 10) && 
                (Parameters.Position.Y < Sprint1Main.Game.Scene.Mario.GetMinPosition.Y))
            {
